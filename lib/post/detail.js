...
module.exports = {
    ...
    detail : (req, res)=>{
        ...
        if(login===true){
            ...
            db.query(`SELECT p.postId, p.title, m.nickName, p.date, p.contents, p.reportCount FROM post p JOIN member m ON p.memberId = m.memberId ORDER BY postId DESC`, (error, results)=>{
