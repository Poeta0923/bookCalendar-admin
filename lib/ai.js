...
module.exports = {
    ...
    view : async(req, res)=>{
        ...
        if(login===true){
            try {
                ...
                //의도 파악 모델 세부 정보 저장
                const intentionDetail = await new Promise((resolve, reject) => {
    ...
    updateAuto : async (req, res)=>{
        ...
        const requestData = {
	        ...
	        "intentionAuto": intentionModelAuto, 
        ...
        if(login===true){
            try {
                ...
                db.query(`SELECT * FROM intentionAi WHERE modelName = ?`,
                    [aiData.intentionModel], (error1, result1)=>{
                        ...
                        if(result1.length===1){
                            ...
                            db.query(`UPDATE intentionAi SET accuracy = ? WHERE modelName = ?`,
                                [aiData.intentionScore, aiData.modelName], (error2, result2)=>{
