...
module.exports = {
    ...
    //'/post/:currentPage/:postId/deletePost 요청 응답
    deletePost : (req, res)=>{
                ...
                [postId], (error, result)=>{
                    ...
                    db.query(`DELETE FROM post WHERE postId = ?`,
                        [postId], (error, results)=>{
                            ...
                            res.redirect(`/admin/post/${currentPage}`);
                            res.end();
                        }
                    )
                }
    ...
    //'/post/search/:currentPage/:postId/deletePost 요청 응답
                ...
                [postId], (error, result)=>{
                    ...
                    db.query(`DELETE FROM post WHERE postId = ?`,
                        [postId], (error, results)=>{
                            ...
                            res.send(`
                                <form id="redirectForm" action="/admin/post/search/${currentPage}" method="post">
    ...
    //'/post/:currentPage/:postId/:commentId/deleteComment' 요청 응답
        ...
        if(login===true){
            ...
            db.query(`DELETE FROM comment WHERE commentId = ?`,
                [commentId], (error, result)=>{
                    ...
                    res.redirect(`/admin/post/${currentPage}/${postId}`);
                    res.end();
                }
            )
        }
    ...
    //'/post/search/:currentPage/:postId/:commentId/deleteComment' 요청 응답
        ...
        if(login===true){
            ...
            db.query(`DELETE FROM comment WHERE commentId = ?`,
                [commentId], (error, result)=>{
                    ...
                    // 클라이언트에게 POST 요청을 보내는 JavaScript 코드 응답
                    res.send(`
                        <form id="redirectForm" action="/admin/post/search/${currentPage}/${postId}" method="post">
                            <input type="hidden" name="searchTerm" value="${searchTerm}">
                        </form>
                        <script>
                            document.getElementById('redirectForm').submit();
